    ...
    <div className='w-full h-full flex'>
      ...
      <div className='h-full w-full bg-app-black overflow-auto'>
        <div className='navbar w-full h-1/10 bg-black flex items-center justify-end'>
          ...
          <div className='2/5 flex justify-around h-full items-center'>
          <TextWithHover displayText={"Sign up"} />
          <div className='bg-white h-2/3 px-8 flex items-center justify-center font-semibold 
          rounded-full cursor-pointer'>Log in</div>
          </div>
